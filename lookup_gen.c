...
//extern char __strtod_internal;if(!my_strcmp(name,"__strtod_internal"))return &__strtod_internal;
...
//extern char __write;if(!my_strcmp(name,"__write"))return &__write;
...
//extern char ___brk_addr;if(!my_strcmp(name,"___brk_addr"))return &___brk_addr;
...
//extern char __curbrk;if(!my_strcmp(name,"__curbrk"))return &__curbrk;
...
//extern char __printf_chk;if(!my_strcmp(name,"__printf_chk"))return &__printf_chk;
...
//extern char __vsnprintf_chk;if(!my_strcmp(name,"__vsnprintf_chk"))return &__vsnprintf_chk;
//extern char __strcat_chk;if(!my_strcmp(name,"__strcat_chk"))return &__strcat_chk;
...
//extern char __vsprintf_chk;if(!my_strcmp(name,"__vsprintf_chk"))return &__vsprintf_chk;
...
//extern char __strcpy_chk;if(!my_strcmp(name,"__strcpy_chk"))return &__strcpy_chk;
...
extern char __stack_chk_fail;if(!my_strcmp(name,"__stack_chk_fail"))return &__stack_chk_fail;
...
extern char __sprintf_chk;if(!my_strcmp(name,"__sprintf_chk"))return &__sprintf_chk;
...
extern char __stpcpy_chk;if(!my_strcmp(name,"__stpcpy_chk"))return &__stpcpy_chk;
...
extern char __snprintf_chk;if(!my_strcmp(name,"__snprintf_chk"))return &__snprintf_chk;
...
//extern char __fprintf_chk;if(!my_strcmp(name,"__fprintf_chk"))return &__fprintf_chk;
extern char __memcpy_chk;if(!my_strcmp(name,"__memcpy_chk"))return &__memcpy_chk;
...
extern char __strncat_chk;if(!my_strcmp(name,"__strncat_chk"))return &__strncat_chk;
...
//extern char __pow_finite;if(!my_strcmp(name,"__pow_finite"))return &__pow_finite;
//extern char __atan2_finite;if(!my_strcmp(name,"__atan2_finite"))return &__atan2_finite;
//extern char __acos_finite;if(!my_strcmp(name,"__acos_finite"))return &__acos_finite;
...
extern char __strncpy_chk;if(!my_strcmp(name,"__strncpy_chk"))return &__strncpy_chk;
...
extern char times;if(!my_strcmp(name,"times"))return &times;
...
//extern char __finitef;if(!my_strcmp(name,"__finitef"))return &__finitef;
...
extern char div;if(!my_strcmp(name,"div"))return &div;
...
extern char setsockopt;if(!my_strcmp(name,"setsockopt"))return &setsockopt;
extern char read;if(!my_strcmp(name,"read"))return &read;
extern char getpwuid;if(!my_strcmp(name,"getpwuid"))return &getpwuid;
//extern char __isoc99_fscanf;if(!my_strcmp(name,"__isoc99_fscanf"))return &__isoc99_fscanf;
extern char dup;if(!my_strcmp(name,"dup"))return &dup;
//extern char __asinf_finite;if(!my_strcmp(name,"__asinf_finite"))return &__asinf_finite;
extern char _setjmp;if(!my_strcmp(name,"_setjmp"))return &_setjmp;
extern char clock_gettime;if(!my_strcmp(name,"clock_gettime"))return &clock_gettime;
extern char cbrt;if(!my_strcmp(name,"cbrt"))return &cbrt;
extern char inet_ntoa;if(!my_strcmp(name,"inet_ntoa"))return &inet_ntoa;
extern char lseek;if(!my_strcmp(name,"lseek"))return &lseek;
extern char select;if(!my_strcmp(name,"select"))return &select;
extern char chdir;if(!my_strcmp(name,"chdir"))return &chdir;
extern char recvfrom;if(!my_strcmp(name,"recvfrom"))return &recvfrom;
extern char geteuid;if(!my_strcmp(name,"geteuid"))return &geteuid;
extern char ioctl;if(!my_strcmp(name,"ioctl"))return &ioctl;
extern char usleep;if(!my_strcmp(name,"usleep"))return &usleep;
extern char gethostname;if(!my_strcmp(name,"gethostname"))return &gethostname;
extern char getenv;if(!my_strcmp(name,"getenv"))return &getenv;
extern char setsid;if(!my_strcmp(name,"setsid"))return &setsid;
extern char execve;if(!my_strcmp(name,"execve"))return &execve;
//extern char __acosf_finite;if(!my_strcmp(name,"__acosf_finite"))return &__acosf_finite;
extern char fcntl;if(!my_strcmp(name,"fcntl"))return &fcntl;
extern char bind;if(!my_strcmp(name,"bind"))return &bind;
//extern char __isoc99_sscanf;if(!my_strcmp(name,"__isoc99_sscanf"))return &__isoc99_sscanf;
extern char clock_getres;if(!my_strcmp(name,"clock_getres"))return &clock_getres;
extern char fileno;if(!my_strcmp(name,"fileno"))return &fileno;
extern char sendto;if(!my_strcmp(name,"sendto"))return &sendto;
//extern char __longjmp_chk;if(!my_strcmp(name,"__longjmp_chk"))return &__longjmp_chk;
//extern char _environ;if(!my_strcmp(name,"_environ"))return &_environ;
extern char freeaddrinfo;if(!my_strcmp(name,"freeaddrinfo"))return &freeaddrinfo;
extern char dladdr;if(!my_strcmp(name,"dladdr"))return &dladdr;
extern char getsockname;if(!my_strcmp(name,"getsockname"))return &getsockname;
extern char __memset_chk;if(!my_strcmp(name,"__memset_chk"))return &__memset_chk;
extern char socket;if(!my_strcmp(name,"socket"))return &socket;
extern char getaddrinfo;if(!my_strcmp(name,"getaddrinfo"))return &getaddrinfo;
extern char pthread_detach;if(!my_strcmp(name,"pthread_detach"))return &pthread_detach;
extern char inet_addr;if(!my_strcmp(name,"inet_addr"))return &inet_addr;
//extern char environ;if(!my_strcmp(name,"environ"))return &environ;
extern char umask;if(!my_strcmp(name,"umask"))return &umask;
extern char gethostbyname;if(!my_strcmp(name,"gethostbyname"))return &gethostbyname;
extern char connect;if(!my_strcmp(name,"connect"))return &connect;
extern char recv;if(!my_strcmp(name,"recv"))return &recv;
extern char send;if(!my_strcmp(name,"send"))return &send;
